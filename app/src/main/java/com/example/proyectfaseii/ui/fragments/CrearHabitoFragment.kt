...
class CrearHabitoFragment : Fragment() {
    ...
    private fun setupSave() {
        btnSave.setOnClickListener {
            ...
            val habito = Habito(
                ...
                goal = Goal(
                    unit_type = "veces",      // o "minutos", "pasos", etc.
                    value = 1.0,              // valor objetivo (1 vez al día por defecto)
                    periodicity = recurrence  // usa el mismo valor que el campo de recurrencia
                ),
